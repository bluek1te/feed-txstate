...
USEFUL: install postman and submit requests to the backend server (which is by default
configured to launch on a local host). Also, install pgAdmin 4, a PostgreSQL tool
, to monitor how your code is storing the data.


The "customer" files are meatn to be used as a template to create our 
...
NOTE: This server is not connected to the front end app yet. It can be launched separately from the front end app.
